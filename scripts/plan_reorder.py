...
# 主流程
# =========================
def reorder_plan(domain_path: Path, problem_path: Path, plan_path: Path, output_path: Path) -> None:
...
if __name__ == "__main__":
    ROUND_DIR = Path(
"/inspire/hdd/project/robot-decision/xiaoyunxiao-240108120113/swm/eval_results/gemini-3-flash-preview/agibot/task_327/episode_648642/round1"        
        
        )
    DOMAIN_PATH = ROUND_DIR / "domain.pddl"
    PROBLEM_PATH = ROUND_DIR / "problem.pddl"
    PLAN_PATH = ROUND_DIR / "plan.txt"
    OUTPUT_PATH = ROUND_DIR / "plan.txt"
    reorder_plan(DOMAIN_PATH, PROBLEM_PATH, PLAN_PATH, OUTPUT_PATH)